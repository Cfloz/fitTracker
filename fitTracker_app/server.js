...
app.get("/any", (req, res) => {
	//this is a route that starts with '/any'
...
app.get("/retrieve", (req, res) => {
	//this is a route that starts with '/retrieve'
	if (req.session.anyProperty === "any value") {
		//if the anyProperty property on the session object is equal to 'any value'
		console.log("match!");
...
app.get("/updateSession", (req, res) => {
	//this is a route that starts with '/updateSession'')
